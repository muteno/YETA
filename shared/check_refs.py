...
_FWD_UNUSED = {
    ...
    '--accent', '--accent-rgb',   # nomute 계승 강조(초록) — 앱 배선은 --brand(네온레몬)로 전면 이관(260704 다크 V2). 정의 보존 사유 = 구성도/ 레거시 문서(가이드북·상태머신 등)가 base.css 거울로 참조. 앱 코드에서 재사용 금지
}
